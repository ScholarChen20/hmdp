...
public class RedisConstants {
    ...
    public static final String SHOP_CACHE_INVALIDATION_TOPIC = "cache:shop:invalidate";
    ...
    public static final String SECKILL_RESERVATION_INDEX_KEY = "seckill:reservation:index";
